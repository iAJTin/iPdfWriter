...
namespace iTin.Core.ComponentModel.Results
{
    ...
    public class EpochPeriodResult : ResultBase<EpochPeriod>
    {
        ...
        /// </returns>
        public new static EpochPeriodResult CreateErrorResult(string message, string code = "") => CreateErrorResult(new IResultError[] { new ResultError { Code = code, Message = message } });
        ...
        /// A new invalid <see cref="EpochPeriodResult"/> with specified detailed error.
        /// </returns>
        public new static EpochPeriodResult CreateErrorResult(string message, EpochPeriod result, string code = "") => CreateErrorResult(new IResultError[] { new ResultError { Code = code, Message = message } }, result);
