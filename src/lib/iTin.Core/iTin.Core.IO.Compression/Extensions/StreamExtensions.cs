...
namespace iTin.Core.IO.Compression
{
    ...
    public static class StreamExtensions
    {
        ...
        #region [public] {static} (IResult) TrySaveAsZip(this Stream, string, string): Returns a value indicating whether zip compressed file has been created
        /// <summary>
        ...
        /// Operation result.
        /// </returns>
        public static IResult TrySaveAsZip(this Stream target, string streamExtension, string outputPath) => target.AsByteArray().TrySaveAsZip(streamExtension, outputPath);
        #endregion
