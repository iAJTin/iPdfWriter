...
namespace iTin.Core.Interop.Shared.Windows.Development.DeviceAndDriverInstallation.SetupApi
{
    ...
    public static class NativeMethods
    {
        ...
        #region [public] {static} {extern} (bool) SetupDiOpenDevRegKey (IntPtr, ref SP_DEVINFO_DATA, KnownSetupDiGetDeviceRegistryProperty, uint, uint, uint): Open a registration key for device specific configuration information
        /// <summary>
