    ...
    public class FileLog : ILog
    {
        ...
        public string Filename
        {
            get
            {
                ...
                var assembly = new Uri(Assembly.GetCallingAssembly().CodeBase);
                var rootPath = assembly.AbsolutePath.ToUpperInvariant();
                var rootDirectory = Path.GetDirectoryName(rootPath);

                var hasAppName = !string.IsNullOrEmpty(ApplicationName);
                var logFilename = 
                    Settings
                        .FilenamePattern
        ...
        /// </summary>
        public void ShowLog() => SystemHelper.RunProgram("Notepad", _filename);
