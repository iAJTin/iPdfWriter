...
namespace iTin.Utilities.Pdf.Writer.ComponentModel
{
    ...
    public sealed class PageNumberSystemTag : ISystemTag
    {
        ...
        /// </summary>
        /// <value>
        /// Always return <see cref="SystemTags.PageNumber"/>.
        /// </value>
        public SystemTags Tag => SystemTags.PageNumber;
        #endregion
        ...
        #region [public] (ISystemTagTextReplacement) BuildReplacementObject(): Returns a reference to an object that replaces text based on the implementation of the ITextReplacement interface
        /// <summary>
        /// Returns a reference to an object that replaces text based on the implementation of the <see cref="ITextReplacement"/> interface.
        /// </summary>
        /// <returns>
        /// A reference that implements the <see cref="ITextReplacement"/> interface.
        /// </returns>
