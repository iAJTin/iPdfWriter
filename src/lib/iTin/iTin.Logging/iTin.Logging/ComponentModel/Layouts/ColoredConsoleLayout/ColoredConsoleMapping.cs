...
namespace iTin.Logging.ComponentModel
{
    ...
    public class ColoredConsoleMapping
    {
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly ColoredConsoleMapping DefaultFatalMapping = new()
        {
            Level = LogLevel.Fatal,
            ForeColor = ConsoleColor.White,
            BackColor = ConsoleColor.Red, 
            Pattern = KnownPatterns.DefaultFatalPattern
        };
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly ColoredConsoleMapping DefaultErrorMapping = new()
        {
            Level = LogLevel.Error, 
            ForeColor = ConsoleColor.Red, 
            BackColor = ConsoleColor.Black, 
            Pattern = KnownPatterns.DefaultErrorPattern
        };
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly ColoredConsoleMapping DefaultInfoMapping = new()
        {
            Level = LogLevel.Info, 
            ForeColor = ConsoleColor.White, 
            BackColor = ConsoleColor.Black,
            Pattern = KnownPatterns.DefaultPattern
        };
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly ColoredConsoleMapping DefaultDebugMapping = new()
        {
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly ColoredConsoleMapping DefaultWarnMapping = new()
        {
            Level = LogLevel.Warn,
        ...
        public override string ToString() => 
            $"Level = {Level}, ForeColor = {ForeColor}, BackColor = {BackColor}, Patterns = {Pattern.Count()}";
