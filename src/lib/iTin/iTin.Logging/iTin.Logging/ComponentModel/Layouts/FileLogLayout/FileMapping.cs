...
namespace iTin.Logging.ComponentModel
{
    ...
    public class FileMapping
    {
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly FileMapping DefaultFatalMapping = new()
        {
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly FileMapping DefaultErrorMapping = new()
        {
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly FileMapping DefaultInfoMapping = new()
        {
            Level = LogLevel.Info, 
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly FileMapping DefaultDebugMapping = new()
        {
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly FileMapping DefaultWarnMapping = new()
        {
            Level = LogLevel.Warn, 
            Pattern = KnownPatterns.DefaultPattern
        };
