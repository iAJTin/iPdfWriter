...
namespace iTin.Logging.ComponentModel
{
    ...
    public class ConsoleMapping
    {
        ...
        public static readonly ConsoleMapping NotFoundMapping = new();

        /// <summary>
        /// Returns new instance of <see cref="ConsoleMapping"/> configured for <b>Fatal</b> log level.
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly ConsoleMapping DefaultFatalMapping = new()
        {
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly ConsoleMapping DefaultErrorMapping = new()
        {
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly ConsoleMapping DefaultInfoMapping = new()
        {
            Level = LogLevel.Info, 
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly ConsoleMapping DefaultDebugMapping = new()
        {
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public static readonly ConsoleMapping DefaultWarnMapping = new()
        {
            Level = LogLevel.Warn, 
            Pattern = KnownPatterns.DefaultPattern
        };
