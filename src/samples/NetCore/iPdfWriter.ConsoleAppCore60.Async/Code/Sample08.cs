...
namespace iPdfWriter.Code
{
    ...
    /// <summary>
    /// Shows the use of save as zip merged output asynchronously.
    /// </summary>
    internal static class Sample08
    {
        public static async Task GenerateAsync(ILogger logger, YesNo useTestMode = YesNo.No, CancellationToken cancellationToken = default)
        {
            ...
            var saveResult = await mergeResult.Result.Action(new SaveToFileAsync { OutputPath = "~/Output/Sample08/Sample-08" }, cancellationToken);
