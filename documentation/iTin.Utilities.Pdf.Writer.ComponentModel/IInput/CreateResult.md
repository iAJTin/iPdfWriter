...
Returns a new reference [`OutputResult`](../../iTin.Utilities.Pdf.Writer.ComponentModel.Result.Output/OutputResult.md) that complies with what is indicated in its configuration object. By default, an [`IInput`](../IInput.md) will not be zipped.
