# SetBase.Apply method (1 of 2)

Try to execute the set action.

```csharp
public SetResult Apply(Stream input, IInput context)
```
...
# SetBase.Apply method (2 of 2)

Try to execute the set action.

```csharp
public SetResult Apply(string file, IInput context)
```
